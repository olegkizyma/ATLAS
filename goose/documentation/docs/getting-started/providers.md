...
| [xAI](https://x.ai/)                                                        | Access to xAI's Grok models including grok-2, grok-2-vision, and other Grok models with extended context windows.                                                                                                            | `XAI_API_KEY`, `XAI_HOST` (optional)                                                                                                                                                |
