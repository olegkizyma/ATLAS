// Source: ./ui/desktop/src/components/BaseChat.tsx
// Role: Serves as the foundational chat component for managing the lifecycle, rendering, and user interactions within the Goose Desktop application. It supports advanced chat and context features, including recipes, file handling, and cost tracking.
/**
 * BaseChat Component
 *
