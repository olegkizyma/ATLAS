// Source: ./ui/desktop/src/components/settings/chat/ChatSettingsSection.tsx
// Role: Provides a modular section for configuring chat-specific settings such as modes, response formatting, voice dictation, tool strategies, and scheduling options in the Goose application.
