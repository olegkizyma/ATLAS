// Source: ./ui/desktop/src/hooks/useMessageStream.ts
// Role: Provides a React hook to handle streaming chat messages, manage state, and process events for the Goose application chat.
