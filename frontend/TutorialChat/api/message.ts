// Source: ./ui/desktop/src/types/message.ts
// Role: Defines the structure of chat messages, including content types, roles, helper functions, and serialization logic for stable communication between client and server.
/**
