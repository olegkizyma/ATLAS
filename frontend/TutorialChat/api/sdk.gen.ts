// Source: ./ui/desktop/src/api/sdk.gen.ts
// Role: Provides autogenerated TypeScript SDK functions for Goose's API endpoints, simplifying HTTP requests with type-safe utilities.
