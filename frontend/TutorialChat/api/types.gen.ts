// Source: ./ui/desktop/src/api/types.gen.ts
// Role: Contains autogenerated TypeScript type definitions for Goose API interactions, ensuring data consistency between backend and frontend.
