// Source: ./ui/desktop/src/components/ToolCallConfirmation.tsx
// Role: Renders a tool call confirmation component allowing users to manage permissions for tools, with options like allow once, always allow, or deny.
